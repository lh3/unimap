...
INCLUDES=
OBJS=		kthread.o kalloc.o misc.o bseq.o sketch.o options.o yak-count.o index.o lchain.o align.o hit.o map.o format.o esterr.o ksw2_ll_sse.o
PROG=		unimap
LIBS=		-lm -lz -lpthread
...
kthread.o: kthread.h
lchain.o: umpriv.h unimap.h bseq.h kseq.h kalloc.h krmq.h
